...
def main():
    parser = argparse.ArgumentParser(description='ControlNet Depth to Image')
    ...
    parser.add_argument('--detect_resolution', type=int, default=384, help='Depth detection resolution (128-1024)')
    ...
    # Save depth map
    depth_output = args.output.replace('.png', '_depth.png')
    Image.fromarray(detected_map).save(depth_output)
